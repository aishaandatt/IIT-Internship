...
def Register():
    ...
    # path_reg = cv2.imwrite('faces'+'/'+str(ctr)+'.jpg', roi_gray)
...
clearButton1 = tk.Button(window, text="Clear", command=clear3, fg="black", bg="#DEBA9D",
                         width=10, height=1, activebackground="#DEBA9D", font=('roboto', 15, ' bold '))
clearButton1.place(x=950, y=100)
